...
<body>
    ...
    <jsp:include page="head.jsp">
        <jsp:param value="units" name="curPage"/>
    </jsp:include>
    <!--头部代码结束-->
                ...
                <div class="span13">
                    <div class="label-div t-20 border-all">
                        ...
                        <div id="teacher_row" class="label-main clearfix" style="padding-left: 16px;">
                            <div class="span12 b-30" id="units_row"></div>
                        </div>
                    </div>
                </div>
                <!--联盟介绍结束-->
        ...
        jQuery(function(){
            ...
            $.post("<%=basePath%>index/query.do",function(result){
                ...
                if(!!data.type && data.type == 'success')
                {
                    ...
                    // 联盟动态 
                    if(!!data.units){
                        $('div#units_row').append(getHTMLForUnits2(data.units));
                    }else{
                    	$('div#units_row').append("暂时没有联盟单位信息");
                    }
                }
                else
                {
