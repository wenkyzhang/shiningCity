...
import com.shiningcity.weixin.entity.MyX509TrustManager;
...
public class CommonUtil
{
 ...
 // 凭证获取（GET）
     ...
     * @return
     */
    public static GlobalAccessToken getToken(String corpid, String corpsecret)
    {
        GlobalAccessToken token = null;
        String requestUrl = token_url.replace("APPID", corpid).replace("APPSECRET", corpsecret);
        // 发起GET请求获取凭证
